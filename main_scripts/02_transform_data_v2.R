...
load('../data/data_raw/full_set_of_series.RData')
load('../data/data_raw/full_description_of_series.RData')
...
names(release) <- sapply(data.full, function(x) x$id)

save(predictors, file = '../data/data_clean/predictors.RData')
save(outcome, file = '../data/data_clean/outcome.RData')
save(release, file = '../data/data_clean/release.RData')
