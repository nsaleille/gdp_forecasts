...
sourceDirectory('./fonctions/extract_data', recursive = FALSE,, modifiedOnly = FALSE)

## Data Loading

sources <- c("./data/insee/full", "./data/eurostat", './data/ocde', './data/bdf', './data/fred')
...
save(data.full, file = './full_set_of_series.RData')
save(search.full, file= './full_description_of_series.RData')